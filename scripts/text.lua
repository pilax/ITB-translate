...
--	Tutorial_FinalIsland_Title = "Mission Finale",
	...
	Store_Purchase = "Acheter équipements pour        Réputation(s)", -- star image goes in here
	Store_Sell = "  Vendre armes ou pilotes pour        Réputation(s)", --star image goes in here
	Store_SellTitle = "VENDRE",
	Store_BuyTitle = "ACHETER",
	Store_Weapons = "Armes",
