...
TILE_TOOLTIPS = {
	...
	seismic = {"Activité Sismique", "This tile will become a Chasm at the start of the enemy turn."},
	...
	ice_storm = {"Tempête de Glace", "The storm causes anything present to become Frozen."},
	grassland = {"Grassland", "Votre objectif bonus is to terraform Grassland tiles into Sand"},
