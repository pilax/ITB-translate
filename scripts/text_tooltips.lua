...
local STATUS_TOOLTIPS = {
	...
	danger = {"Danger Environnemental", "The environment effect will affect this space next turn"},
	purple = {"Unité Alpha", "Alpha units are more powerful than their standard counterparts"},
...
local PilotSkills = {
	...
	Shifty = PilotSkill("Agile","After attacking, gain 1 free tile movement."),
