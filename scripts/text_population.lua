...
local PopEvent = {
	Opening = { "Nous sommes sauvés !", "J'savais qu'ils viendraient !", "L'#squad !", "C'est l'#squad !", "Maintenant les Veks n'ont qu'à bien s'tenir !", "Les Veks vont le regretter maintenant !", "Prends mes lunettes !\nJe veux voir !", "Arrêtez d'encombrer la fenêtre !", "Que se passe-t-il ?", "Les Mechs ont atterri !", "#corp a envoyé des Mechs !", "Quel est ce bruit ?", "Tu as entendu quelque chose ?", "C'est bien eux ?", "Ils sont là !", "'Man, regarde !", "Les Mechs !", "'Pa, regarde !", "Nous sommes sauvés !", "Enfin !", "Les secours sont là !", "Ils sont venus !", "Les Mechs sont là !", "Ils vont nous protéger !", },
