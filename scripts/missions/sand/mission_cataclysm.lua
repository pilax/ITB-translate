...
Env_Cataclysm = Environment:new{
	Name = "Séisme Cataclysmique",
	Text = "Les tuiles marquées deviendront des Gouffres au début du tour ennemi, tuant toutes les unités terrestres présentes.",
	StratText = "CATACLYSME",
	CombatIcon = "combat/tile_icon/tile_crack.png",
	CombatName = "CATACLYSME",
	Index = 0,
	WaterTarget = true,
}
